    ...
    <div className={classes.flex}>
      ...
      <div className={classes.language}>
        <div className={classes.header}>
          <SvgIcon customClass={classes.svg} section="footer" width="24" icon="globus" />
          <span>English</span> 
        </div>
      </div>
    </div>
